...
namespace rt
{
	...
	public:
		...
		__device__ __host__ PointLight(PointLight const& other):
			m_position(other.m_position),
			m_color(other.m_color)
		{}

		__device__ __host__ PointLight(Vector3f const& pos, Colorf const& color):
			m_position(pos),
			m_color(color)
		{}
		...
		__device__ __host__ Vector3f position()const
		{
			return m_position;
		}
